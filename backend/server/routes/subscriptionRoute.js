...
router.get("/mostrarQuemSubscreveu/:id", authorize(roles.gestor, roles.funcionario, roles.anonimo), controller.mostrarQuemSubscreveu);
router.get("/mostrarQuemFoiSubscrito/:id", authorize(roles.gestor, roles.funcionario, roles.anonimo), controller.mostrarQuemFoiSubscrito);
